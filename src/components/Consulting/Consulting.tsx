...
export default function Consulting() {
  return (
    <div className={styles.ConsultingComponent + ' bg-black'}>
      {/* Consulting */}
      <div className='mx-auto max-w-3xl bg-black px-4 py-16 text-left'>
        ...
        <div className='ml-0 flex justify-center text-left'>
          <Button>
            <Link
              ...
              target='_blank'
            >
              <p className='font-secondary'>BOOK A CALL</p>
            </Link>
          </Button>
        </div>
      </div>
