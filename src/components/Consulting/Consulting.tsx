  ...
  return (
    ...
    >
      ...
      <div className=' w-full bg-black px-4 py-16 text-left'>
        {/* <p className='font-primary font-bolder  mx-auto max-w-4xl px-4 text-5xl uppercase text-white'>
        ...
        <p className='font-secondary  my-8 flex max-w-4xl bg-black px-4 text-left text-2xl  font-thin   text-white'>
